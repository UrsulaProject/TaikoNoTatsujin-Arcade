...
@interface OAToken : NSObject <NSCoding>
{
    ...
    NSString *session;	// 24 = 0x18
    NSNumber *duration;	// 32 = 0x20
    NSMutableDictionary *attributes;	// 40 = 0x28
    NSDate *created;	// 48 = 0x30
    _Bool renewable;	// 56 = 0x38
    _Bool forRenewal;	// 57 = 0x39
    NSString *verifier;	// 64 = 0x40
}
