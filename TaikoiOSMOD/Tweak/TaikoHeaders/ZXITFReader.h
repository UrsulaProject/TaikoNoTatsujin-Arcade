...
{
    int _narrowLineWidth;	// 8 = 0x8
}

+ (void)initialize;
@property(nonatomic) int narrowLineWidth; // @synthesize narrowLineWidth=_narrowLineWidth;
- (int)decodeDigit:(int *)arg1 countersSize:(int)arg2;
- (id)findGuardPattern:(id)arg1 rowOffset:(int)arg2 pattern:(int *)arg3 patternLen:(int)arg4;
