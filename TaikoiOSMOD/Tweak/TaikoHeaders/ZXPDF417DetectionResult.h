...
{
    int _barcodeColumnCount;	// 8 = 0x8
    ZXPDF417BoundingBox *_boundingBox;	// 16 = 0x10
    ZXPDF417BarcodeMetadata *_barcodeMetadata;	// 24 = 0x18
    NSMutableArray *_detectionResultColumnsInternal;	// 32 = 0x20
}

@property(nonatomic) int barcodeColumnCount; // @synthesize barcodeColumnCount=_barcodeColumnCount;
@property(retain, nonatomic) NSMutableArray *detectionResultColumnsInternal; // @synthesize detectionResultColumnsInternal=_detectionResultColumnsInternal;
@property(retain, nonatomic) ZXPDF417BarcodeMetadata *barcodeMetadata; // @synthesize barcodeMetadata=_barcodeMetadata;
