...
{
    NSMutableArray *_possibleLeftPairs;	// 8 = 0x8
    NSMutableArray *_possibleRightPairs;	// 16 = 0x10
}

@property(retain, nonatomic) NSMutableArray *possibleRightPairs; // @synthesize possibleRightPairs=_possibleRightPairs;
@property(retain, nonatomic) NSMutableArray *possibleLeftPairs; // @synthesize possibleLeftPairs=_possibleLeftPairs;
- (void).cxx_destruct;
